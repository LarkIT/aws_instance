...
yum -y install puppet-agent sssd realmd krb5-workstation samba-common-tools oddjob oddjob-mkhomedir sssd adcli
...
#Join to the domain
echo '${joiner_pw}' | kinit ${joiner_account}@${upper(ad_domain)}
